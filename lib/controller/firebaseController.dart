import 'package:chat21_flutter/model/userModel.dart';
import 'package:flutter/material.dart';
import 'package:firebase_auth/firebase_auth.dart';

/////// source:https://medium.com/flutter-community/flutter-firebase-login-using-provider-package-54ee4e5083c7
////// source: https://github.com/KenAragorn/create_flutter_provider_app
...
class FirebaseController extends ChangeNotifier {
  ...
  UserModel _userFromFirebase2(User user, String idToken) {
    if (user == null) {
      return null;
    }
  ...
  Future<UserModel> registerWithEmailAndPassword(
    ...
    try {
      ...
      return _userFromFirebase2(result.user, idToken);
    } catch (e) {
